...
This function will build gene vectors based on the transcript
coordinates of every gene
...
- trans_lst:
  ...
  If specified, it is a list of named dataframes. Each dataframe refers
  to one sample and shows the transcript detection coordinates for each
  gene. Optional parameter.
